// Page Name : "attendedPatientAppointments"
// Page Id : "c4eve9"
...
const AttendedPatientAppointments = () => {
  ...
  useEffect(() => {
    window.scrollTo(0, 0);
    setTitle(t("attendedPatientAppointments"));
    setIsLink(true);
    setScreenName("");
    setSelectDateAndHp(false);
    dispatch(setActiveScreenName("attendedPatientAppointmentScreen"));
    ...
    <Mui.Grid container>
      <Mui.Grid item xs={12}>
        <PatientAppointmentTable
          rows={dummyData.ROWS}
          noRecordsMessage={t("noAttendedAppointments")}
          screenName="attendedPatientAppointments"
        />
      </Mui.Grid>
    </Mui.Grid>
  );
...
export default AttendedPatientAppointments;
