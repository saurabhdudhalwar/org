...
const AppointmentsInputFieldGroup = (prop: any) => {
  ...
  const serviceAppointmentForm = useFormik({
    ...
    validationSchema: yup.object().shape({
      startDate: yup
        ...
        .when([], {
          is: () =>
            !serviceAppointmentForm.touched.patientBarcode === true &&
            serviceAppointmentForm.values.patientBarcode === "",
          then: yup
            .date()
            .nullable()
  ...
  return (
    <form onSubmit={serviceAppointmentForm.handleSubmit} noValidate>
          ...
          <GridItem>
            <Common.CellmaDatePicker
              ...
              onChange={(newDate: Date | null) => {
                ...
                serviceAppointmentForm.setFieldTouched(
                  "startDate",
                  true,
                  false
                );
              ...
              error={
                serviceAppointmentForm.touched.startDate &&
                serviceAppointmentForm.errors.startDate
                  ? serviceAppointmentForm.errors.startDate
                  : ""
              }
            />
          ...
          <GridItem>
            <Common.CellmaDatePicker
              ...
              onChange={(newDate: Date | null) => {
                ...
                serviceAppointmentForm.setFieldTouched("endDate", true, false);
              }}
              onBlur={serviceAppointmentForm.handleBlur}
              error={
                serviceAppointmentForm.touched.endDate &&
                serviceAppointmentForm.errors.endDate
                  ? serviceAppointmentForm.errors.endDate
                  : ""
              }
            />
